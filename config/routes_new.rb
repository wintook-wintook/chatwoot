Rails.application.routes.draw do
    ...
    namespace :v1 do
      ...
      resources :accounts, only: [:create, :show, :update] do
        ...
        scope module: :accounts do
          ...
          # 🎯 AGREGAR ESTA LÍNEA PARA EL DELETE SIMPLE
          ...
          # AGREGAR ESTAS RUTAS AQUÍ (fuera de conversations):
          ...
          resources :conversations, only: [:index, :create, :show, :update] do
            collection do
              ...
              post :filter
              #mndn kanban ini
              get :available_kanban_types  # Nueva ruta
              #mndn kanban fin
            end
          ...
          # 🎯 mndn kanban routes add:
          # resources :kanban_processes do
            # resources :kanban_type_processes do
              # Ahora kanban_type_processes es la ruta principal (pero manteniendo el path original)
              resources :kanban_type_processes, path: 'kanban_processes' do
                # Y kanban_processes son las sub-rutas (etapas)
  ...
  post 'webhooks/discourse/:account_id/:api_key', to: 'webhooks/discourse#process_payload'
