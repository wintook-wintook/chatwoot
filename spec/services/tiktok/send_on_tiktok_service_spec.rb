  ...
  describe '#perform' do
    ...
    it 'marks message as failed when conversation cannot send images' do
      ...
      expect(Messages::StatusUpdateService).to have_received(:new).with(
        message,
        'failed',
        I18n.t('errors.tiktok.image_not_supported')
      )
      expect(tiktok_client).not_to have_received(:send_media_message)
    end
    ...
    it 'marks message as failed when attachment is not an image' do
      ...
      expect(Messages::StatusUpdateService).to have_received(:new).with(message, 'failed', I18n.t('errors.tiktok.attachment_not_an_image'))
      expect(tiktok_client).not_to have_received(:send_media_message)
    end
    ...
    it 'marks message as failed when image format is unsupported' do
      ...
      expect(Messages::StatusUpdateService).to have_received(:new).with(message, 'failed', I18n.t('errors.tiktok.unsupported_image_format'))
      expect(tiktok_client).not_to have_received(:send_media_message)
    end
    ...
    it 'marks message as failed when image is larger than 3 MB' do
      ...
      expect(Messages::StatusUpdateService).to have_received(:new).with(message, 'failed', I18n.t('errors.tiktok.image_too_large'))
      expect(tiktok_client).not_to have_received(:send_media_message)
    end
  end
end
