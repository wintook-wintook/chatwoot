...
export const colors = {
  woot: {
    25: 'rgb(var(--color-woot-25, 245 250 255) / <alpha-value>)',
    50: 'rgb(var(--color-woot-50, 237 246 255) / <alpha-value>)',
    75: 'rgb(var(--color-woot-75, 225 240 255) / <alpha-value>)',
    100: 'rgb(var(--color-woot-100, 206 231 254) / <alpha-value>)',
    200: 'rgb(var(--color-woot-200, 150 199 242) / <alpha-value>)',
    300: 'rgb(var(--color-woot-300, 94 176 239) / <alpha-value>)',
    400: 'rgb(var(--color-woot-400, 82 169 255) / <alpha-value>)',
    500: 'rgb(var(--color-woot-500, 54 158 255) / <alpha-value>)',
    600: 'rgb(var(--color-woot-600, 0 144 255) / <alpha-value>)',
    700: 'rgb(var(--color-woot-700, 9 84 165) / <alpha-value>)',
    800: 'rgb(var(--color-woot-800, 13 56 104) / <alpha-value>)',
    900: 'rgb(var(--color-woot-900, 15 27 45) / <alpha-value>)',
  },
  green: {
  ...
  slate: {
    25: 'rgb(var(--color-slate-25, 248 249 250) / <alpha-value>)',
    50: 'rgb(var(--color-slate-50, 241 243 245) / <alpha-value>)',
    75: 'rgb(var(--color-slate-75, 236 238 240) / <alpha-value>)',
    100: 'rgb(var(--color-slate-100, 230 232 235) / <alpha-value>)',
    200: 'rgb(var(--color-slate-200, 215 219 223) / <alpha-value>)',
    300: 'rgb(var(--color-slate-300, 193 200 205) / <alpha-value>)',
    400: 'rgb(var(--color-slate-400, 155 161 166) / <alpha-value>)',
    500: 'rgb(var(--color-slate-500, 120 127 133) / <alpha-value>)',
    600: 'rgb(var(--color-slate-600, 104 112 118) / <alpha-value>)',
    700: 'rgb(var(--color-slate-700, 76 81 85) / <alpha-value>)',
    800: 'rgb(var(--color-slate-800, 38 41 43) / <alpha-value>)',
    900: 'rgb(var(--color-slate-900, 21 23 24) / <alpha-value>)',
  },
  black: {
    50: slate.slate2,
