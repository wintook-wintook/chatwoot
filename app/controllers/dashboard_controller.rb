  ...
  def app_config
    {
      ...
      # Canal nativo de Instagram: solo se expone si está configurado, nunca el secreto.
      # El front lo usa para atenuar la tarjeta; la URL de autorización se arma en backend.
