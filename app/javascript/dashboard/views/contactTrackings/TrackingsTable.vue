  ...
  <div class="flex flex-col gap-4">
    ...
    <div class="flex flex-col gap-3 p-3 rounded-lg bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700">
      ...
      <label class="text-sm font-medium text-slate-600 dark:text-slate-300 flex flex-col gap-1 flex-1 min-w-[160px]">
        Buscar
        <input v-model="filters.q" type="text" placeholder="Contacto u objetivo…" class="text-sm rounded border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-900 h-9 px-2" @keyup.enter="fetch(1)" />
      </label>
